#ifndef _LIB_ILI9341_H_
#define _LIB_ILI9341_H_
...
namespace Lib
{
	...
	namespace Ili9341
	{
		...
		class Base
		{
			...
			public: // SETTERS
				void rotation(ILI9341::ROTATION new_rotation);
				void window_location(const Point& point0, const Point& point1);

			public: // METHODS
				void initialize(void);
				//
				virtual void send(ILI9341::COMMAND command) = 0;
